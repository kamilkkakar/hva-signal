...
export const INTERACTION_HOVER_LINE = "#c45c26";
export const INTERACTION_SELECT_LINE = "#c45c26";
...
export const INTERACTION_LINE_WIDTH = 0.7;
export const INTERACTION_HOVER_LINE_WIDTH = 2.1;
export const INTERACTION_SELECT_LINE_WIDTH = 3.2;
export const INTERACTION_SELECT_HALO = "#fff4e8";
export const INTERACTION_SELECT_HALO_WIDTH = 6.5;
