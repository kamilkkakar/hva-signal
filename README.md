...
Thermal data comes from FortyGuard; geography and context use Census, ACS and canopy datasets. Live requests check the cache before acquisition. Optional PostgreSQL coordination preserves reservations and responses across API instances and restarts; without it, coordination is process-local. Cached results remain available after the allowance is spent.
